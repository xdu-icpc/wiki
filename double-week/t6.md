...
|[rand](/nonexist)|`+`|B|`+`|`-`|`+`|`-`|`-`|`+`|`+`|J|-|-|-|
|[SGR](/team/SGR)|`+`|`-`|`+`|`+`|`+`|`-`|`+`|`+`|`+`|`-`|-|-|-|
|[the_path_to_ac](/nonexist)|`+`|B|`+`|`+`|E|`-`|G|`-`|`+`|J|-|-|-|
...
|EasyMath -> [Double Rainbow](/team/EasyMath/训练记录/orzpanda)|`+`|`-`|`-`|`-`|`-`|F|G|`+`|`+`|`-`|-|-|-|
...
|:-:|:-:|:-:|
|rand               | $\max(10, 10+2) = 10$ | |
|voyage             | $\max(10, 6 + 5) = 10$ | |
|the_path_to_ac     | $4 + 2 - 3 = 3$ | 没有训练记录 |
|Dream_to_AC        | $6 - 1 = 5$ | |
|Triwater           | $7 + 0 = 7$ | |
|Three_binary_trees | $1 + 0 = 1$ | |
|miao_miao_miao     | $8 + 0 = 8$ | |
|Triy               | $6 + 0 = 6$ | |
|take_your_time     | $7 + 0 = 7$ | |
|HTT                | $7 - 1 = 6$ | |
|Double Rainbow     | $6 - 1 = 5$ | |
|Nothing Gold Can Stay | $10 - 3 = 7$ | 没有训练记录 |
|Senior_typists     | $4 - 3 = 1$ | |
|Celeste            | $9 + 1 - 1 = 9$ | |
|AK to SHIZHI       | $6 - 2 = 4$ | |