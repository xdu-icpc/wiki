...
|[the_path_to_ac](/team/the_path_to_ac)|-|-|C|-|E|F|-|-|-|-|-|-|-|
...
|[AK to SHIZHI](/team/AK-to-SHIZHI/4)|-|-|C|-|E|F|-|-|-|-|-|-|-|
...
|rand               | $8 + 1 = 9$ | |
|voyage             | $5 + 0 = 5$ | 拉题队不加分 |
|the_path_to_ac     | $4 + 0 = 4$ | |
|Dream_to_AC        | $6 + 0 = 6$ | |
|Triwater           | $7 + 0 = 7$ | |
|Three_binary_trees | $2 + 0 = 2$ | |
|miao_miao_miao     | $7 + 1 = 8$ | |
|Triy               | $6 + 0 = 6$ | |
|take_your_time     | $6 + 1 = 7$ | |
|HTT                | $7 + 0 = 7$ | |
|EasyMath           | $6 + 0 = 6$ | |
|zyjyzxy            | $\min(10, 8 + 3) = 10$| 封顶 |
|Senior_typists     | $3 + 2 = 5$ | |
|Celeste            | $7 + 1 = 8$ | |
|AK to SHIZHI       | $6 + 0 = 6$ | |